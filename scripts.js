//criar classe para mapear todos as validações existentes 
class Validator{
    constructor(){
        this.validations = [
            'data-required',
    ...
    //iniciar a validação de todos os compos
    validate(form){
        //resgatar todos as validações 
    ...
    //verificar se o  input tem um número minimo de caracteres
        minlength(input, minValue){
            ...
            let errorMessage = `o compo precisa ter pelo menos ${minValue} carecteres` ;
    ...
    onlyletters(input){
        ...
        let errorMessage = `Esta campo não aceita número nem caracteres especiais.`;
    ...
    equal(input, inputName){
        ...
        if(input.valeu != inputToCampare.value){
            this.printMessage(input, errorMessage);
        };
    };
    ...
    //verificar se o requerido (exigido)
    required(input){
        let inputValue = input.value;
...
//pegar os dados do formulário do botão
